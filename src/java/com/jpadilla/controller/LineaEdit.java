 ...
 * @author jpadilla
 */
@WebServlet(name = "LineaEdit", urlPatterns = {"/lineaedit"})
public class LineaEdit extends HttpServlet {

    public static MyLogger logs = (MyLogger) MyLogger.getLogger("LineaEdit");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("mensaje", "SE HA ENCONTRADO LA LINEA");
        request.getRequestDispatcher("editlinea.jsp").forward(request, response);
