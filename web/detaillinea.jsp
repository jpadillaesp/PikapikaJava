    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Detalle de Linea</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-xs-12">
                            ...
                            <c:forEach items="${requestScope.objeto}" var="linea">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 widget-right">
                                        <a href="${pageContext.request.contextPath}/lineaedit?id=${linea.id_linea}">Editar</a>
                                        <a href="${pageContext.request.contextPath}?listlinea">Volver a la Lista</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </fieldset>
